...
int32 pc_mapid2jobid(uint64 class_, int32 sex)
{
	...
	//4-1 Jobs
		...
		case MAPID_DRAGON_KNIGHT|JOBL_UPPER:      return JOB_DRAGON_KNIGHT;
		case MAPID_ARCH_MAGE:
		case MAPID_ARCH_MAGE|JOBL_UPPER:          return JOB_ARCH_MAGE;
		case MAPID_WINDHAWK:
		case MAPID_WINDHAWK|JOBL_UPPER:           return JOB_WINDHAWK;
		case MAPID_CARDINAL:
		case MAPID_CARDINAL|JOBL_UPPER:           return JOB_CARDINAL;
		case MAPID_MEISTER:
		case MAPID_MEISTER|JOBL_UPPER:            return JOB_MEISTER;
		case MAPID_SHADOW_CROSS:
		case MAPID_SHADOW_CROSS|JOBL_UPPER:       return JOB_SHADOW_CROSS;
		case MAPID_SKY_EMPEROR:           return JOB_SKY_EMPEROR;
	//4-2 Jobs
		case MAPID_IMPERIAL_GUARD:
		case MAPID_IMPERIAL_GUARD|JOBL_UPPER:     return JOB_IMPERIAL_GUARD;
		case MAPID_ELEMENTAL_MASTER:
		case MAPID_ELEMENTAL_MASTER|JOBL_UPPER:   return JOB_ELEMENTAL_MASTER;
		case MAPID_TROUBADOURTROUVERE:
		case MAPID_TROUBADOURTROUVERE|JOBL_UPPER: return sex?JOB_TROUBADOUR:JOB_TROUVERE;
		case MAPID_INQUISITOR:
		case MAPID_INQUISITOR|JOBL_UPPER:         return JOB_INQUISITOR;
		case MAPID_BIOLO:
		case MAPID_BIOLO|JOBL_UPPER:              return JOB_BIOLO;
		case MAPID_ABYSS_CHASER:
		case MAPID_ABYSS_CHASER|JOBL_UPPER:       return JOB_ABYSS_CHASER;
